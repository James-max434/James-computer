    ...
    dialog.innerHTML = `
        <div class="exploration-content">
            ...
            <div class="location-details">
                <div class="macau-info">
                    <h3>${location.macau.name}</h3>
                    <p>${location.macau.description}</p>
                    <p class="history">${location.macau.history}</p>
                </div>
                
                <div class="genshin-info">
                    <h3>${location.genshin.name}</h3>
                    <p>${location.genshin.description}</p>
                    <p class="connection">${location.genshin.connection}</p>
                </div>
            </div>
                ...
                <div class="task-list">
                    ${location.tasks.map(task => `
                        <div class="task-item">
                            ...
                            <div class="task-reward">獎勵：${task.reward}</div>
                            <button class="start-task-btn" onclick="startTask('${locationId}', '${task.name}')">
                                開始任務
                            </button>
                        </div>
                    `).join('')}
